...
1. Install Docker and verify the version:   
**docker --version   
docker-compose --version**   
2. Build and Run Services using Docker Compose: **docker-compose up --build**   
3. Verify Running Containers: **docker ps**   
4. Access the application at **http://localhost:3000**   
5. Stop and Clean Up Services: **docker-compose down**   
